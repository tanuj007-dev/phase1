...
const HeroSectionAbout = () => {
  ...
  return (
    <div className="bg-[#f0faf5] min-h-screen font-sans overflow-x-hidden">
      {/* --- Optimized Navbar --- */}
      <motion.nav 
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        transition={{ duration: 0.8, ease: "circOut" }}
        className="pt-6 flex justify-center sticky top-0 z-50"
      >
        <div className="bg-white/90 backdrop-blur-sm px-6 py-2 rounded-full shadow-sm border border-gray-100 flex gap-8">
          {["Home", "Features", "About", "Pricing", "Blog"].map((item) => (
            <motion.a 
              whileHover={{ y: -2 }}
              key={item} 
              href="#" 
              className="text-[13px] font-semibold text-gray-400 hover:text-black transition-colors"
            >
              {item}
            </motion.a>
          ))}
      ...
      <section className="pt-10 pb-12 px-4">
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] font-bold text-gray-800 uppercase tracking-wider">Joined 2k+ Members</span>
          </motion.div>
          ...
          >
            Changing How <br /> Healthcare <motion.span 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          >
            ...
            >
               ...
               <p className="text-gray-400 text-[11px] font-semibold uppercase tracking-wide">Trusted Worldwide</p>
            </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 p-6 text-left">
                ...
                <p className="text-white/60 text-[9px] font-bold uppercase tracking-widest">Founder, Medicare</p>
              </div>
            </motion.div>
            ...
            >
              <div className="relative w-fit">
                <img src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=80" className="w-10 h-10 rounded-full object-cover" alt="user" />
                <motion.div 
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-[11px] font-semibold uppercase tracking-wide">User Rating</p>
                </div>
              </div>
            </motion.div>
